	...
	<div class="w3-container">
		...
		<form action="${pageContext.request.contextPath}/review/insert"
			...
			<div class="w3-section">
				<label>제목</label> <input class="w3-input" name="title" type="text"	required>
			</div>
			<div class="w3-section">
				<label>내용</label>
			...
			첨부파일1 : <input type="file" name="attachFile1"><br> 첨부파일2
			: <input type="file" name="attachFile2"><br> 첨부파일3 : <input
				type="file" name="attachFile3"><br>
			<div class="w3-center">
				<button type="submit"
					class="w3-btn w3-xlarge w3-blue w3-hover-white"
					onclick="document.getElementById('id02').style.display='block'"
					style="font-weight: 000;">등록</button>
			</div>
		</form>
